...
import org.project.paysystem.revenue.repository.VideoCumulativeStatsRepository;
import org.project.paysystem.revenue.repository.VideoPagingRepository;
...
public class VideoCumulativeBatch {
    ...
    public JpaPagingItemReader<UserVideoHistoryBatchDto> watchTimeReader() {
        ...
        return new JpaPagingItemReaderBuilder<UserVideoHistoryBatchDto>()
                ...
                .queryString("SELECT new org.project.paysystem.revenue.dto.UserVideoHistoryBatchDto(u.video.id, SUM(u.watchTime)) " +
